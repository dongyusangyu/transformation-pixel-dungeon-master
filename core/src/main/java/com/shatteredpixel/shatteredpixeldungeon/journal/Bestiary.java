...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.TransformMimic;
...
public enum Bestiary {
	...
	static {
		...
		BOSSES.addEntities(Goo.class, WarriorBoss.class,
				...
				GoldBoss.GoldElemental.class,GoldBoss.Thymor.class,GoldBoss.MonkMaster.class,GoldBoss.GoldGolem.class, GreatShoper.class);

		UNIVERSAL.addEntities(Wraith.class, Piranha.class, Mimic.class, GoldenMimic.class, EbonyMimic.class, TransformMimic.class, Statue.class, GuardianTrap.Guardian.class, SentryRoom.Sentry.class,
				LandPiranha.class);
		...
		RARE.addEntities(Albino.class, GnollExile.class, HermitCrab.class,CausticSlime.class,
				...
				Acidic.class,
				TormentedSpirit.class, PhantomPiranha.class, CrystalMimic.class, ArmoredStatue.class, PhantomLandPiranha.class);
