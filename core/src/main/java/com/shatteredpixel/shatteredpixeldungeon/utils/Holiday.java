...
public enum Holiday {
    ...
    TRAN_BIRTHDAY;          //Jan 3st to Jan 20th                                   (20 days)
	...
	public static Holiday getHolidayForDate(GregorianCalendar cal){
        ...
        //蜕变生日
        if ((cal.get(Calendar.MONTH) == Calendar.JANUARY && cal.get(Calendar.DAY_OF_MONTH) >= 3)
                && (cal.get(Calendar.MONTH) == Calendar.JANUARY && cal.get(Calendar.DAY_OF_MONTH) <= 20)){
            return TRAN_BIRTHDAY;
        }
