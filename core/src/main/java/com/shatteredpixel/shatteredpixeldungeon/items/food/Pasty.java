...
public class Pasty extends Food {
	...
	public void reset() {
		...
		switch(Holiday.getCurrentHoliday()){
			...
			case NEW_YEARS:
				...
				break;
            case TRAN_BIRTHDAY:
                image = ItemSpriteSheet.TRAN_CAKE;
                break;
		}
	}
	...
	protected void satisfy(Hero hero) {
		...
		if(hero.pointsInTalent(Talent.EATEN_SLOWLY)==2){
		...
		switch(Holiday.getCurrentHoliday()){
			...
			case NEW_YEARS:
				...
				break;
            case TRAN_BIRTHDAY:
                GLog.p(Messages.get(this, "tran_eat"));
                Buff.affect(hero, TranCake.class);
                break;
		}
	}
	...
	public String name() {
		switch(Holiday.getCurrentHoliday()){
            ...
            case TRAN_BIRTHDAY:
                return Messages.get(this, "tran_name");
		}
	}
	...
	public String desc() {
		switch(Holiday.getCurrentHoliday()){
            ...
            case TRAN_BIRTHDAY:
                return Messages.get(this, "tran_desc");
		}
	}
    ...
    public static class TranCake extends Buff {
        @Override
        public int icon() {
            return BuffIndicator.LUCKYCOIN;
        }
        public void tintIcon(Image icon) { icon.hardlight(0.647f, 0.439f, 1.0f); }
    }
}
