...
public class PotionOfMastery extends ExoticPotion {
	...
	protected WndBag.ItemSelector itemSelector = new WndBag.ItemSelector() {
		...
		public boolean itemSelectable(Item item) {
			return
					(item instanceof Weapon && !(item instanceof SpiritBow) && !((Weapon) item).masteryPotionBonus) && !(item instanceof SprayGun)
                            && !(item instanceof RitualDagger) && !(item instanceof Tatteki)
