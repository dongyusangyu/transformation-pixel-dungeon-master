...
public abstract class ExoticScroll extends Scroll {
	...
	static{
		...
		regToExo.put(ScrollOfTransmutation.class, ScrollOfUpTier.class);
		exoToReg.put(ScrollOfUpTier.class, ScrollOfTransmutation.class);
	}
	...
	public static class ScrollToExotic extends Recipe {
		...
		public Item brew(ArrayList<Item> ingredients) {
			...
			try {
				...
				result.quantity(1 + Talent.miracleAlchemyBonus(hero, result));
				return result;
			} catch (Exception e) {
