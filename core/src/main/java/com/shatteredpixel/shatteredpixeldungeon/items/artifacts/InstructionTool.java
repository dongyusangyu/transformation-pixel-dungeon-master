...
public class InstructionTool extends Artifact {
    ...
    public CellSelector.Listener dronerecharge = new CellSelector.Listener(){
        ...
        public void onSelect(Integer cell) {
            ...
            if(drone!=null && drone instanceof InstructionTool.Drone){
                ...
                GLog.w( Messages.get(InstructionTool.class, "huishou_cancel") );
            }
            return;
        }
        @Override
    ...
    public class toolRecharge extends ArtifactBuff implements ActionIndicator.Action {
        ...
        public void doAction() {
            ...
            if(drone != null ){
                ...
                String desc=null;
                if(Dungeon.droneVison){
                    desc = Messages.get(InstructionTool.class, "vison_open");
                }else{
                    desc = Messages.get(InstructionTool.class, "vison_close");
                }
                ...
                GameScene.show(new WndOptions(new ItemSprite(ItemSpriteSheet.ARTIFACT_TOOL),
                    ...
                    protected void onSelect(int index) {
                        if (index == 0){
                            ...
                            Dungeon.droneVison=!Dungeon.droneVison;
                            Dungeon.observe();
                        }
                    }
                });
    ...
    public static class InstructionMark extends Buff {
        private float left;
        public int icon() {
            if(hero.subClass.is(HeroSubClass.AT400)){
                return BuffIndicator.AT400MARK;
            }else if(hero.subClass.is(HeroSubClass.AU400)){
    ...
    public static class Drone extends DirectableAlly {
        ...
        public void die( Object cause ) {
            if(hero!=null && hero.buff(HoneyComb.HoneyCombBuff.class)!=null){
                hero.heal((int)(hero.HT*(0.04f+0.005f*hero.pointsInTalent(Talent.GLORIOUS_DEAD))));
                ...
                Sample.INSTANCE.play( Assets.Sounds.HIVE_CLUSTER_DIED,1f );
            }else{
    ...
    protected WndBag.ItemSelector itemSelector = new WndBag.ItemSelector() {
        ...
        public boolean itemSelectable(Item item) {
            if(curUser.subClass.is(HeroSubClass.AT400)){
            ...
            }else if(curUser.subClass.is(HeroSubClass.AU400)){
        ...
        public void onSelect(Item item) {
            if (item != null && item instanceof Scroll && item.isIdentified()){
                ...
                if(item instanceof ScrollOfUpgrade){
                    ...
                    GLog.p( Messages.get(InstructionTool.class, "levelup") );
                }else{
