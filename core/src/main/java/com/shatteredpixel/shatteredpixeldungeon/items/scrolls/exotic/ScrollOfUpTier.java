...
public class ScrollOfUpTier extends ExoticScroll {
    {
    ...
    protected WndBag.ItemSelector itemSelector = new WndBag.ItemSelector() {
        ...
        public void onSelect( Item item ) {
            ...
            //it would be better to eliminate the curItem static variabl
    ...
    protected boolean usableOnItem(Item item) {
        ...
        if (item instanceof MeleeWeapon){
            ...
            return !(item instanceof ClassArmor || item instanceof SlimeArmor || ((Armor) item).checkSeal()!=null || ((Armor) item).tier>4);
            //all regular or exotic potions. No brews or elixirs
            ...
            return (item instanceof Ring && !(item instanceof RingOfKing)) || item instanceof Wand || item instanceof Trinket
    ...
    private static Weapon changeWeapon( Weapon w ) {
        ...
        if (w instanceof MeleeWeapon) {
            c = Generator.wepTiers[Math.min(((MeleeWeapon)w).tier ,4)];
        } else {
            c = Generator.misTiers[Math.min(((MissileWeapon)w).tier ,4)];
        }
    ...
    private static Armor changeArmor( Armor w ) {
        Armor n;
        switch (w.tier){
            case 1:
                n=new LeatherArmor();
        ...
        n.cursed = w.cursed;
        n.augment = w.augment;
        n.glyphHardened = w.glyphHardened;
    ...
    public int energyVal() {
        return isKnown() ? 16 * quantity : super.energyVal();
    }
