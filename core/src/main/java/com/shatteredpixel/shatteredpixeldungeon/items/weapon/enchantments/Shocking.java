...
public class Shocking extends Weapon.Enchantment {
    ...
    public static void arc1( Char attacker, Char defender, int dist, ArrayList<Char> affected, ArrayList<Lightning.Arc> arcs ) {
        ...
        for (Char hit : hitThisArc){
            arcs.add(new Lightning.Arc(defender.sprite.center(), hit.sprite.center()));
            arc1(attacker, hit, (Dungeon.level.water[hit.pos] && !hit.flying) ? dist+1 : dist, affected, arcs);
        }
