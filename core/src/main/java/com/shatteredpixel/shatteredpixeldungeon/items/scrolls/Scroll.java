...
public abstract class Scroll extends Item {
	...
	public void onThrow( int cell) {
		...
		if(hero.pointsInTalent(Talent.WORD_STUN)>0 && enemy!=null && hero.buffs(Talent.WordStunCooldown.class).isEmpty()){
			Buff.affect(enemy, Paralysis.class,1+hero.pointsInTalent(Talent.WORD_STUN));
			Buff.affect(hero,Talent.WordStunCooldown.class,50);
		}
