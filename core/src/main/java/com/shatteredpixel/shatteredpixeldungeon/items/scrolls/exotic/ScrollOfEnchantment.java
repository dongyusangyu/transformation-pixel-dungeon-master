...
public class ScrollOfEnchantment extends ExoticScroll {
	...
	public static boolean enchantable( Item item ){
		return (item instanceof Weapon || item instanceof Armor)
				...
				|| item instanceof Tatteki || item instanceof SlimeArmor || item instanceof SlimeGirlArmor) || item instanceof RingOfKing || item instanceof RitualDagger;
	}
	...
	protected WndBag.ItemSelector itemSelector = new WndBag.ItemSelector() {
		...
		public void onSelect(final Item item) {
			...
			if(hero.pointsNegative(Talent.CURSEDMAN)==2){
	...
	public static class WndConfirmCancel extends WndOptions{
		...
		protected void onSelect(int index) {
			...
			if (index == 1){
				...
				} else if (WndGlyphSelect.arm != null){
