...
public class RegionLorePage {
	...
	public static DocumentPage pageForDoc( Document doc ){
		switch (doc){
			...
			case BACKS:                return new RegionLorePage.Backs();
			case HERO:                return new RegionLorePage.Hero();
		}
	}
	...
	public static class Backs extends DocumentPage {
		{
			image = ItemSpriteSheet.BACKS_PAGE;
		}

		@Override
		public Document document() {
			return Document.BACKS;
		}
	}
	public static class Hero extends DocumentPage {
		{
			image = ItemSpriteSheet.HERO_PAGE;
		}

		@Override
		public Document document() {
			return Document.HERO;
		}
	}
