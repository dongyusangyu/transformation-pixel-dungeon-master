...
public class Shuriken_Box extends Artifact {
    ...
    public class SmallShuriken extends Shuriken {
        ...
        public void cast(final Hero user, final int dst) {
			Shuriken_Box.this.targetPos = throwPos( user, dst );
    ...
    public String desc() {
        ...
        if (isEquipped( Dungeon.hero )){
            ...
            if (cursed)
                ...
                desc += Messages.get(this, "desc_equipped",knockArrow().min(),knockArrow().max(),
						Messages.decimalFormat("##.#",Math.min(100,(level()+1)*10)));
        }
        return desc;
    }
    ...
    public class shurikenRecharge extends ArtifactBuff{
        ...
        public boolean act() {
            ...
            if (charge < chargeTarget
                ...
                chargeGain *= (float)(RingOfEnergy.artifactChargeMultiplier(target));
