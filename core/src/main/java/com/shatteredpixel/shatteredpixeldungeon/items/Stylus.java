	...
	private final WndBag.ItemSelector itemSelector = new WndBag.ItemSelector() {
		...
		public boolean itemSelectable(Item item) {
			if(hero.hasTalent(Talent.KEBI)){
				return item instanceof Armor || item instanceof Weapon || item instanceof RingOfKing;
			}else{
				return item instanceof Armor || item instanceof RingOfKing;
			}
		...
		public void onSelect( Item item ) {
			...
			}else if(item != null && item instanceof RingOfKing){
                if(hero.hasTalent(Talent.KEBI)){
                    ((RingOfKing)item).enchant(Stylus.this);
                }else{
                    if(((RingOfKing)item).glyph != null)
                        ((RingOfKing)item).glyph=Armor.Glyph.random(((RingOfKing)item).glyph.getClass());
                    else
                        ((RingOfKing)item).glyph=Armor.Glyph.random();
