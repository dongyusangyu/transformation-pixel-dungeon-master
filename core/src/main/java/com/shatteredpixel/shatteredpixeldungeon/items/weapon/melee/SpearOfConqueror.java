...
public class SpearOfConqueror extends MeleeWeapon {

    {
        image = ItemSpriteSheet.SPEARCONQUEROR;      //贴图
        //image = ItemSpriteSheet.SPEAR;      //贴图
    ...
    @Override
    public int max(int lvl) {//伤害最大值
        return  Math.round(7f*(tier+1)) +    //20 base, up from 15
    ...
    public String upgradeAbilityStat(int level){
        int dmgBoost = 8 + Math.round(1.5f*buffedLvl());
