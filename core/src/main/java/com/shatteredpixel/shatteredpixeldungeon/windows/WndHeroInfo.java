	...
	public WndHeroInfo( HeroClass cl ){
		...
		switch (cl){
			...
			case CLERIC:
				...
				break;
			case FREEMAN:
				tabIcon = new ItemSprite(ItemSpriteSheet.SPECIAL_PACKAGE,null);
				break;
			case SLIMEGIRL:
			...
			case DM400:
				...
				break;
			case PRINCESS:
				tabIcon = new ItemSprite(ItemSpriteSheet.RING_KING,null);
				break;
            case FRIAR:
                tabIcon = new ItemSprite(ItemSpriteSheet.SPRAYGUN_BASE,null);
                break;
			case RATKING:
				tabIcon = new ItemSprite(ItemSpriteSheet.ARMOR_MAGE, null);
		}
			...
			switch (cls){
				case WARRIOR: default:
					icons = new Image[]{ new ItemSprite(ItemSpriteSheet.SEAL),
							new ItemSprite(ItemSpriteSheet.ARMOR_PLATE),
				...
				case DUELIST:
					...
					break;
				case FREEMAN:
					icons = new Image[]{ new ItemSprite(ItemSpriteSheet.SPECIAL_PACKAGE),
							new ItemSprite(ItemSpriteSheet.SCROLL_META),
							new ItemSprite(ItemSpriteSheet.WALK_STICK),
							new ItemSprite(ItemSpriteSheet.SCROLL_ISAZ)};
					break;
				case CLERIC:
				...
				case DM400:
					...
					break;
                case PRINCESS:
                    icons = new Image[]{ new ItemSprite(ItemSpriteSheet.RING_KING),
                            new ItemSprite(ItemSpriteSheet.STONE_ENCHANT),
                            new ItemSprite(ItemSpriteSheet.BRACER),
                            new ItemSprite(ItemSpriteSheet.SCROLL_ISAZ)};
                    break;
                case FRIAR:
                    icons = new Image[]{ new ItemSprite(ItemSpriteSheet.SPRAYGUN_BASE),
                            new BuffIcon(BuffIndicator.REASON,true),
                            new ItemSprite(ItemSpriteSheet.LWHIP),
                            new ItemSprite(ItemSpriteSheet.SCROLL_ISAZ)};
                    break;
				case RATKING:
					// placeholder, even if it is funny.
					icons = new Image[info.length];
					for(int i=0; i < icons.length; i++) icons[i] = new ItemSprite(ItemSpriteSheet.ARMOR_MAGE);
			}
			for (Image im : icons) {
				add(im);
			}
