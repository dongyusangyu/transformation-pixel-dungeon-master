...
public class WndNinjaAbilities extends Window {
    ...
    public WndNinjaAbilities( Ninja_Energy energyBuff ){
        super();
        ...
        for (Ninja_Energy.NinjaAbility abil : Ninja_Energy.NinjaAbility.abilities) {
            String text = "_" + Messages.titleCase(abil.name(energyBuff)) + " " + Messages.get(this, "energycost", abil.energyCost(energyBuff)) + ":_ " + abil.desc(energyBuff);
    ...
    Ninja_Energy.NinjaAbility abilityBeingUsed;
