...
public class WndClericSpells1 extends Window {
	...
	public WndClericSpells1(RubbingsTome tome, Hero cleric, boolean info){
		...
		IconButton btnInfo = new IconButton(info ? new ItemSprite(tome) : Icons.INFO.get()){
			...
			protected void onClick() {
				GameScene.show(new WndClericSpells1(tome, cleric, !info));
				hide();
			}
		};
	...
	public class SpellButton extends IconButton {
		...
		public SpellButton(ClericSpell spell, RubbingsTome tome, boolean info){
