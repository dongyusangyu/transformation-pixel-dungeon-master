...
public class WndSadGhost extends Window {
	...
	private void selectReward( Item reward ) {
		...
		Weapon weapon=Ghost.Quest.weapon;
		if(Ghost.Quest.enchant != null){
			weapon.enchant(Ghost.Quest.enchant);
		}
		...
		if(hero.hasTalent(Talent.GHOST_GIFT) && (reward instanceof  Armor) && hero.pointsInTalent(Talent.GHOST_GIFT)+2> Random.Int(4)){
			weapon.identify();
			Dungeon.level.drop( weapon, ghost.pos ).sprite.drop();
		}
