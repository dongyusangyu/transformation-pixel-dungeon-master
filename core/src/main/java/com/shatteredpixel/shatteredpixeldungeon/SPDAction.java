...
public class SPDAction extends GameAction {
	...
	public static final GameAction TAG_ACTION1   = new SPDAction("tag_action1");
	...
	static {
		...
		defaultBindings.put( Input.Keys.V,              SPDAction.TAG_ACTION1 );
	...
	static {
		...
		defaultControllerBindings.put( Input.Keys.DPAD_CENTER+1001,     SPDAction.TAG_ACTION1 );
