...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		btnPlay = new StyledButton(GREY_TR, Messages.get(this, "enter")){
			...
			protected boolean onLongClick() {
				...
				if (DeviceCompat.isDebug()) {
					if (SaveManager.getFirstEmptySlot() != -1){
						GamesInProgress.selectedClass = null;
						GamesInProgress.curSlot = SaveManager.getFirstEmptySlot();
		...
		btnSupport = new StyledButton(GREY_TR,Messages.get(this, "seedfind")){
			@Override
			protected void onClick() {
		...
		if (landscape()) {
			 ...
			 */
			btnSettings.setRect(btnJournal.right()+2, btnJournal.top(), btnRankings.width(), BTN_HEIGHT);
			btnChanges.setRect(btnRankings.left(), btnJournal.bottom()+GAP, btnRankings.width(), BTN_HEIGHT);
			btnAbout.setRect(btnChanges.right()+2, btnSettings.bottom()+GAP, btnRankings.width(), BTN_HEIGHT);
		} else {
			...
			btnSettings.setRect(btnChanges.right()+2, btnRankings.bottom()+ GAP, btnRankings.width(), BTN_HEIGHT);
			btnAbout.setRect(btnRankings.left(), btnChanges.bottom()+ GAP,  title.width(), BTN_HEIGHT);
		}
