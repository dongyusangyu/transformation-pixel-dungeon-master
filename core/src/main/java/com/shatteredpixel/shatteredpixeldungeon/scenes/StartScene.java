...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		btnImport.setRect(btnSort.right() + 8, btnSort.top(), btnImport.reqWidth() + 4, 12);
		add(btnImport);
	...
	private class SaveSlotButton extends Button {
		...
		public void set( int slot ){
			...
			if (newGame){
				...
				if (hero == null){
					hero = HeroSprite.avatar(info.heroClass, info.armorTier, info.skin);
					add(hero);
					...
					hero.copy(HeroSprite.avatar(info.heroClass, info.armorTier, info.skin));
