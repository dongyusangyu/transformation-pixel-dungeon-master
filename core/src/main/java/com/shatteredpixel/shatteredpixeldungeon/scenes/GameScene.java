...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		if(Dungeon.isChallenged(Challenges.NEGATIVE)){
			if(Dungeon.depth==2 && Dungeon.hero.negativeTalents.isEmpty()){
				add(new WndNegative());
			}
			if(Dungeon.depth==6 && Dungeon.hero.negativeTalents.size()<2){
				add(new WndNegative());
			}
			if(Dungeon.depth==11 && Dungeon.hero.negativeTalents.size()<3){
				add(new WndNegative());
			}
			if(Dungeon.depth==21 && Dungeon.hero.negativeTalents.size()<4){
				add(new WndNegative());
			}
		}
