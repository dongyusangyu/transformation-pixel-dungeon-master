...
public class RenderedTextBlock extends Component {
	...
	protected boolean cjkText = false;
	...
	private int redHightlightColor = CharSprite.NEGATIVE;
	private boolean redhighlightingEnabled = true;
	private int orangeHightlightColor = CharSprite.ORANGE;
	private boolean orangehighlightingEnabled = true;
	private int blueHightlightColor = 0x00FF00;
	private boolean bluehighlightingEnabled = true;
	private int greenHightlightColor = CharSprite.POSITIVE;
	private boolean greenhighlightingEnabled = true;
	...
	public void text(String text){
		this.text = text;
		cjkText = Messages.containsCJK(text);
	...
	protected synchronized void layout() {
		...
		for (int i = 0; i < words.size(); i++){
			...
			if (word == SPACE){
				...
				while (!cjkText
						&& Messages.lang() != Languages.CHI_SMPL && Messages.lang() != Languages.CHI_TRAD
