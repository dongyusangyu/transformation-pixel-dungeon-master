...
public class HeroIcon extends Image {
	...
	public  static  final  int DRONEDIRECT = 116;
    public static final int BALANCE = 117;
    public static final int INVASION = 118;
	...
	public static final int CREDULOUS = 170;
    ...
    public static final int RUNEMAGE = 198;
    public static final int COMBATMASTER = 199;
    public static final int MARCHFORWARD = 200;
    public static final int TABOOMAGIC = 201;
    public static final int KINGBLADE = 202;
    public static final int ALCHEMIST = 203;
    public static final int PIOUS = 204;
    public static final int REASONDOSE = 205;
    public static final int CONPOTION = 206;
    public static final int HOLY_PRAYER = 207;
