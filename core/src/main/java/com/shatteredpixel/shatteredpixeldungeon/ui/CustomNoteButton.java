...
public class CustomNoteButton extends IconButton {
	...
	protected void onClick() {
		...
		if (Notes.getRecords(Notes.CustomRecord.class).size() >= Notes.customRecordLimit()){
			GameScene.show(new WndTitledMessage.WndTitledMessage1(Icons.INFO.get(),
	...
	private class WndDepthSelect extends WndTitledMessage.WndTitledMessage1 {
		...
		public WndDepthSelect(){
            ...
            resize(width, top + (left == 0 ? 0 : 16) + 16);
	...
	private static class WndItemtypeSelect extends WndTitledMessage.WndTitledMessage1 {
	...
	public static class CustomNoteWindow extends WndJournalItem.WndJournalItem1 {
