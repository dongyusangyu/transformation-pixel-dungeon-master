...
public class BuffIndicator extends Component {
	...
	public static final int MELEESDEFENCE = 84;
	public static final int MISSILESDEFENCE =  85;
	public static final int RESURRECTION =  86;

	public static final int GOLDCURSE =  87;
	public static final int LUCKYCOIN =88;
	...
	public  static  final  int AT400MARK=102;
	...
	public  static  final  int SLIMEMUCUS=111;
	public  static  final  int DHCOOL=112;
	public  static  final  int LOADCOOL=113;
    public  static  final  int RUNEMARK=114;
    public  static  final  int BALANCE=115;
    public  static  final  int INVASION=116;
    public  static  final  int PARRY=117;
    public  static  final  int STANCESTABILIZE=118;
    public  static  final  int STANCECOORDINATION=119;
    public  static  final  int FORWARD=120;
    public  static  final  int DISARM=121;
    public  static  final  int REASON=122;
    public  static  final  int SUFFERING=123;
    public  static  final  int VIRTUE=124;
