...
public enum Icons {
	...
	public static Image get( Icons type ) {
		...
		switch (type) {
			...
			case CHAL_COUNT:
				...
				break;
			case REDCHAL_COUNT:
				icon.frame( icon.texture.uvRectBySize( 160, 88, 7, 7 ) );
				break;
			case COIN_SML:
			...
			case TEST_MODE:
				...
				break;
            case SKIN_GREY:
                icon.frame( icon.texture.uvRectBySize( 169, 0, 14, 12 ) );
                break;
            case SKIN_COLOR:
	...
	public static Image get( HeroClass cl ) {
		switch (cl) {
			...
			case FREEMAN:
				return new ItemSprite(ItemSpriteSheet.SPECIAL_PACKAGE);
			case CLERIC:
            ...
            case PRINCESS:
                return new ItemSprite(ItemSpriteSheet.RING_KING);
            case FRIAR:
                return new ItemSprite(ItemSpriteSheet.SPRAYGUN_BASE);
			default:
				return new ItemSprite(ItemSpriteSheet.SEAL);
		}
	}
