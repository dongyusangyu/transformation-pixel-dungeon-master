...
public class FloatingText extends RenderedTextBlock {
	...
	public static int ENDLESS_MALICE    = 25;
	public static int LIFE_SPORT = 26;
    public static int TERROR = 27;
    public static int DOWN_WHITE = 28;
	...
	public static int getHitReasonIcon(Char attacker, float accRoll, Char defender, float defRoll){
        ...
        if (defRoll == 0
                && defender.buff(Suffering.Despair.class) != null){
            return HIT_SUFFER;
        }
        ...
        /*
        if (attacker.buff(Suffering.Paranoia.class) != null ) hitReasons.put(HIT_SUFFER, 0.8f);
        else if(defender.buff(Suffering.Fear.class) != null ) hitReasons.put(HIT_SUFFER, 0.67f);

         */


        if (defender.buff(Virtue.class) != null){
            hitReasons.put(HIT_VIRTUE, 0.8f);
        }
	...
	public static int getMissReasonIcon(Char attacker, float accRoll, Char defender, float defRoll){
        ...
        if (attacker.buff(Suffering.Paranoia.class) != null ) missReasons.put(MISS_SUFFER, 0.8f);
        else if (defender.buff(Suffering.Fear.class) != null ) missReasons.put(MISS_SUFFER, 1.5f);

        if (attacker.buff(Virtue.class) != null){
            missReasons.put(MISS_VIRTUE, 0.8f);
        }
