...
public class MagicMissile extends Emitter {
	...
	public static final int HEAL_MISSILE   = 17;
	public static final int SPRAY_BASE      = 18;
	public static final int SPRAY_STRENGTH  = 19;
	public static final int SPRAY_TOXIC     = 20;
	public static final int SPRAY_HASTE     = 21;
	public static final int SPRAY_LEVITATION= 22;
	public static final int SPRAY_PURITY    = 23;
	...
	public static final int HEAL_CONE       = 114;
	public static final int SPRAY_BASE_CONE = 115;
	public static final int SPRAY_STRENGTH_CONE = 116;
	public static final int SPRAY_TOXIC_CONE = 117;
	public static final int SPRAY_HASTE_CONE = 118;
	public static final int SPRAY_LEVITATION_CONE = 119;
	public static final int SPRAY_PURITY_CONE = 120;
	...
	public void reset( int type, PointF from, PointF to, Callback callback ) {
		...
		switch(type){
			...
			case HEAL_MISSILE:
				size( 4 );
				pour( MagicParticle.HEAL, 0.03f );
				break;
			case SPRAY_BASE:
				size( 4 );
				pour( BloodParticle.SPRAY_BASE, 0.01f );
				break;
			case SPRAY_STRENGTH:
				size( 4 );
				pour( BloodParticle.SPRAY_STRENGTH, 0.01f );
				break;
			case SPRAY_TOXIC:
				size( 4 );
				pour( BloodParticle.SPRAY_TOXIC, 0.01f );
				break;
			case SPRAY_HASTE:
				size( 4 );
				pour( BloodParticle.SPRAY_HASTE, 0.01f );
				break;
			case SPRAY_LEVITATION:
				size( 4 );
				pour( BloodParticle.SPRAY_LEVITATION, 0.01f );
				break;
			case SPRAY_PURITY:
				size( 4 );
				pour( BloodParticle.SPRAY_PURITY, 0.01f );
				break;
			case SPRAY_EXP:
				size( 4 );
				pour( BloodParticle.SPRAY_EXP, 0.01f );
				break;
			case SPRAY_MIND:
				size( 4 );
				pour( BloodParticle.SPRAY_MIND, 0.01f );
				break;
			case SPRAY_INVIS:
				size( 4 );
				pour( BloodParticle.SPRAY_INVIS, 0.01f );
				break;
			...
			case HEAL_CONE:
				size( 10 );
				pour( BloodParticle.HEAL, 0.03f );
				break;
			case SPRAY_BASE_CONE:
				size( 10 );
				pour( BloodParticle.SPRAY_BASE, 0.03f );
				break;
			case SPRAY_STRENGTH_CONE:
				size( 10 );
				pour( BloodParticle.SPRAY_STRENGTH, 0.03f );
				break;
			case SPRAY_TOXIC_CONE:
				size( 10 );
				pour( BloodParticle.SPRAY_TOXIC, 0.03f );
				break;
			case SPRAY_HASTE_CONE:
				size( 10 );
				pour( BloodParticle.SPRAY_HASTE, 0.03f );
				break;
			case SPRAY_LEVITATION_CONE:
				size( 10 );
				pour( BloodParticle.SPRAY_LEVITATION, 0.03f );
				break;
			case SPRAY_PURITY_CONE:
				size( 10 );
				pour( BloodParticle.SPRAY_PURITY, 0.03f );
				break;
			case SPRAY_EXP_CONE:
				size( 10 );
				pour( BloodParticle.SPRAY_EXP, 0.03f );
				break;
			case SPRAY_MIND_CONE:
				size( 10 );
				pour( BloodParticle.SPRAY_MIND, 0.03f );
				break;
			case SPRAY_INVIS_CONE:
				size( 10 );
				pour( BloodParticle.SPRAY_INVIS, 0.03f );
				break;
		}
	...
	public static class MagicParticle extends PixelParticle {
        ...
        public static final Emitter.Factory HEAL = new Factory() {
            @Override
            public void emit( Emitter emitter, int index, float x, float y ) {
                ((MagicParticle)emitter.recycle( MagicParticle.class )).reset( x, y,0.1804f, 0.902f, 0.1804f );
            }
            @Override
            public boolean lightMode() {
                return true;
