...
public class ItemSpriteSheet {
	...
	public static final int TAMARU    = UNCOLLECTIBLE+7;
	...
	public static final int SMALLSKURIKEN     = UNCOLLECTIBLE+11;
    public static final int RUNESTRING     = UNCOLLECTIBLE+12;
	public static final int RUNESTRING1     = UNCOLLECTIBLE+13;
	static{
		...
		assignItemRect(TAMARU,8, 8);

		
		assignItemRect(TENGU_BOMB,      10, 10);
		assignItemRect(TENGU_SHOCKER,   10, 10);
		assignItemRect(GEO_BOULDER,     16, 14);
		assignItemRect(SMALLSKURIKEN,     10, 10);
        assignItemRect(RUNESTRING,15, 16);
		assignItemRect(RUNESTRING1,15, 16);
	}
	...
	public static final int SPECIAL_PACKAGE     = CONTAINERS+8;
	public static final int REMAINS_CHEST         = CONTAINERS+9;
	static{
		...
		assignItemRect(SPECIAL_PACKAGE,     16, 14);
		assignItemRect(REMAINS_CHEST,     16, 14);
	}
	...
	public static final int ROYAL_JEWELRY       = MISC_CONSUMABLE +26;
    public static final int BOTTLEDENERGY       = MISC_CONSUMABLE +27;
	...
	static{
		...
		assignItemRect(ROYAL_JEWELRY,       10, 10);
        assignItemRect(BOTTLEDENERGY,       10, 12);
	}
	...
	public static final int TATTEKI    = BOMBS+12;
	public static final int SPIDER    = BOMBS+13;
	public static final int SMALLSPIDER    = BOMBS+14;
	...
	static{
		...
		assignItemRect(TATTEKI,   14, 16);
		assignItemRect(SPIDER,   14, 10);
		assignItemRect(SMALLSPIDER,   13, 9);
	}
	...
	public static final int WALK_STICK     = WEP_TIER1+6;
	public static final int SPEARCONQUEROR           = WEP_TIER1+7;
	static{
		...
		assignItemRect(WALK_STICK,     15, 16);
		assignItemRect(SPEARCONQUEROR ,     15, 15);
	}
	...
	public static final int WAKIZASHI          = WEP_TIER2+6;
    public static final int BRACER          = WEP_TIER2+7;
	static{
		...
		assignItemRect(WAKIZASHI,          12, 16);
		assignItemRect(BRACER,          12, 13);
	}
	...
	public static final int BLOWPIPE		= WEP_TIER3+6;
    public static final int LWHIP		= WEP_TIER3+7;
	static{
		...
		assignItemRect(BLOWPIPE,        15, 15);
        assignItemRect(LWHIP,        15, 15);
	}
	...
	public static final int STEEL_WHIP      = WEP_TIER5+7;
	static{
		...
		assignItemRect(STEEL_WHIP,  14, 14);
	}
	...
	public static final int ARMOR_FREEMAN   = ARMOR+11;
	...
	static{
		...
		assignItemRect(ARMOR_FREEMAN,   15, 14);
    ...
    private static final int SPRAYGUN        =                               xy(1, 13);  //16 slots
    public static final int SPRAYGUN_BASE     = SPRAYGUN+0;
    public static final int SPRAYGUN_STRENGTH = SPRAYGUN+1;
    public static final int SPRAYGUN_LIQUID_FLAME = SPRAYGUN+2;
    public static final int SPRAYGUN_HASTE = SPRAYGUN+3;
    public static final int SPRAYGUN_HEALING = SPRAYGUN+4;
    public static final int SPRAYGUN_FROST = SPRAYGUN+5;
    public static final int SPRAYGUN_LEVITATION = SPRAYGUN+6;
    public static final int SPRAYGUN_TOXIC_GAS = SPRAYGUN+7;
    public static final int SPRAYGUN_PURITY = SPRAYGUN+8;
    public static final int SPRAYGUN_PARALYTIC_GAS = SPRAYGUN+9;
    public static final int SPRAYGUN_EXPERIENCE = SPRAYGUN+10;
    public static final int SPRAYGUN_MIND_VISION = SPRAYGUN+11;
    public static final int SPRAYGUN_INVISIBILITY = SPRAYGUN+12;
    public static final int ARMOR_FRIAR = SPRAYGUN+13;
    public static final int RITUAL_DAGGER = SPRAYGUN+14;
    static{
        assignItemRect(SPRAYGUN_BASE,     14, 16);
        assignItemRect(SPRAYGUN_STRENGTH,     14, 16);
        assignItemRect(SPRAYGUN_LIQUID_FLAME,     14, 16);
        assignItemRect(SPRAYGUN_HASTE,     14, 16);
        assignItemRect(SPRAYGUN_HEALING,     14, 16);
        assignItemRect(SPRAYGUN_FROST,     14, 16);
        assignItemRect(SPRAYGUN_LEVITATION,     14, 16);
        assignItemRect(SPRAYGUN_TOXIC_GAS,     14, 16);
        assignItemRect(SPRAYGUN_PURITY,     14, 16);
        assignItemRect(SPRAYGUN_PARALYTIC_GAS,     14, 16);
        assignItemRect(SPRAYGUN_EXPERIENCE,     14, 16);
        assignItemRect(SPRAYGUN_MIND_VISION,     14, 16);
        assignItemRect(SPRAYGUN_INVISIBILITY,     14, 16);
        assignItemRect(ARMOR_FRIAR,     15, 16);
        assignItemRect(RITUAL_DAGGER,     12, 13);
	...
	static {
        ...
        assignItemRect(RING_KING, 10, 10);
	}
	...
	public static final int ARTIFACT_KEY  =  ARTIFACTS+45;
	static{
	...
	public static final int SPYGLASS        = TRINKETS+20;
	public static final int SPEAR_SHIELD    = TRINKETS+22;
    public static final int MAGIC_FEATHER   = TRINKETS+23;
	static{
		...
		assignItemRect(SPEAR_SHIELD,     16, 14);
		assignItemRect(MAGIC_FEATHER,     15, 15);
	}
	...
	public static final int RED_ENVELOPE    = SCROLLS+12;

	public static final int ARCANE_RESIN    = SCROLLS+13;
	public static final int RUBBINGSTOME    = SCROLLS+14;
	public static final int SCROLL_META    = SCROLLS+15;
	...
	static {
		...
		assignItemRect(RED_ENVELOPE, 15, 14);
		assignItemRect(RUBBINGSTOME, 14, 16);
	}
	...
	public static final int SCROLL_SUBLITION    = EXOTIC_SCROLLS+12;
	static {
		for (int i = EXOTIC_SCROLLS; i < EXOTIC_SCROLLS+17; i++)
			assignItemRect(i, 15, 14);
		//assignItemRect(SCROLL_SUBLITION, 15, 14);
	}
	...
	public static final int TRANSFORM_SPELL  = SPELLS+4;
	...
	public static final int TRANSFORMATION_ELE      = SPELLS+13;
	...
	static{
		...
		assignItemRect(TRANSFORM_SPELL,  12, 13);
		...
		assignItemRect(TRANSFORMATION_ELE,       8, 16);
	}
    ...
    public static final int TRAN_CAKE   = FOOD+13;
    public static final int TINCTURE   = FOOD+14;
	static{
	...
	public static final int BACKS_PAGE  = DOCUMENTS+7;
	public static final int HERO_PAGE  = DOCUMENTS+8;
	...
	static{
		...
		assignItemRect(BACKS_PAGE,  10, 11);
		assignItemRect(HERO_PAGE,  10, 11);
	}
	...
	public static class Icons {
		...
		public static final int SCROLL_META = SCROLLS+12;
		static {
			...
			assignIconRect( SCROLL_META,   7, 7 );
		}
		...
		public static final int SCROLL_SUB= EXOTIC_SCROLLS+12;
		static {
