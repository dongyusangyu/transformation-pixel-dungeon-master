...
public class HeroSprite extends CharSprite {
	...
	public static int frameWidth(HeroClass cl) {
		if (cl == HeroClass.RATKING) {
			return RatKingHeroSprite.frameWidth();
		} else {
			return FRAME_WIDTH;
		}
	}
	public static int frameHeight(HeroClass cl) {
		if (cl == HeroClass.RATKING) {
			return RatKingHeroSprite.frameHeight();
		} else {
			return FRAME_HEIGHT;
		}
	}
	...
	public static Image avatar( HeroClass cl, int armorTier ) {
		return avatar(cl, armorTier, Dungeon.skin);
	}
	public static Image avatar( HeroClass cl, int armorTier, int skin ) {
		if (cl == HeroClass.RATKING){
			armorTier = 1;
		}
