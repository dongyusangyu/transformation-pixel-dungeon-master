...
public abstract class RegularLevel extends Level {
	...
	protected void createItems() {
		...
		for (Item item : itemsToSpawn) {
			...
			}else if(Dungeon.isChallenged(Challenges.EXTREME_ENVIRONMENT) && Dungeon.isChallenged(Challenges.MAX_WHEAT)
					&& item instanceof ScrollOfMetamorphosis){
				mobs.add(TransformMimic.spawnAt(cell, TransformMimic.class, item));
			} else {
