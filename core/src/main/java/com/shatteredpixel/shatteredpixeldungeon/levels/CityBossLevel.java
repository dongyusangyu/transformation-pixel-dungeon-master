...
public class CityBossLevel extends Level {
	...
	public static final int[] pedestals = new int[4];
	...
	public void playLevelMusic() {
		if (locked){
			if(Statistics.bossScores[3]>0){
				Music.INSTANCE.play(Assets.Music.BACKS2, true);
			} else if (BossHealthBar.isBleeding()){
	...
	public void reseal() {
		...
		GreatShoper boss = new GreatShoper();
		boss.pos = throne;
		//boss.pos = throne + width();
		GameScene.add( boss );
