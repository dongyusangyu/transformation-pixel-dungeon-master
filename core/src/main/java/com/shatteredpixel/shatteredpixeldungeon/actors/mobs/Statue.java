...
public class Statue extends Mob {
	...
	public void die( Object cause ) {
		if (!this.buffs(Resurrection.REsurrection.class).isEmpty() && !this.properties().contains(BOSS)) {
		...
		if(hero.hasTalent(Talent.WEALTH_STATUE) ){
			int max_item=25;
			...
			if(Dungeon.talent_item<max_item){
				...
				if(Random.Int(3)==0){
					...
					switch(Random.Int(7)){
						case 0: default:
							reward = new RingOfAccuracy();
							break;
						case 1:
							reward = new RingOfElements();
							break;
						case 2:
							reward = new RingOfEvasion();
							break;
						case 3:
							reward = new RingOfForce();
							break;
						case 4:
							reward = new RingOfMight();
							break;
						case 5:
							reward = new RingOfTenacity();
					}
				}

				if(this instanceof GuardianTrap.Guardian){
					reward.level(hero.pointsInTalent(Talent.WEALTH_STATUE));
				}else{
					reward.level(hero.pointsInTalent(Talent.WEALTH_STATUE)+1);
				}
