...
public abstract class ChampionEnemy extends Buff {
	...
	public void fx(boolean on) {
		if (on) target.sprite.aura( color ,5);
		else target.sprite.clearAura();
	}
	@Override
	public boolean act() {
		if(hero!=null && target instanceof  Mob && target.isAlive()){
	...
	public static void rollGiveChampion(Char m){
		...
		if(m instanceof Brute && buffCls==ChampionEnemy.Transform.class){
			buffCls=ChampionEnemy.Holy.class;
		}
	...
	public static void rollForChampion(Mob m){
		...
		switch (Random.Int(random)){
			...
			case 6:				buffCls = Corrosion.class;      break;
			case 7:				buffCls = Haste.class;      break;
			case 8:				buffCls = Holy.class;      break;
			case 9:				buffCls = Transform.class;      break;
		}
	...
	public static class Corrosion extends ChampionEnemy {
		...
		@Override
		public void onAttackProc(Char enemy) {
			Buff.affect(enemy, Ooze.class).set(3);
		}
	...
	public static class Haste extends ChampionEnemy {
	...
	public static class Holy extends ChampionEnemy {
