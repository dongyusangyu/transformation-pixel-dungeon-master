	...
	public boolean interact(Char c) {
		...
		if (Quest.given) {
            ...
            if(Dungeon.hero.heroClass== HeroClass.MAGE){
                ...
                msg1 += Messages.get(this, "intro_" + Dungeon.hero.heroClass.name());
            }
            /*
			switch(Dungeon.hero.heroClass){
				...
				case CLERIC:
					...
					break;
				case FREEMAN:
					msg1 += Messages.get(this, "intro_freeman");
					break;
				case SLIMEGIRL:
					msg1 += Messages.get(this, "intro_slimegirl");
					break;
				case NINJA:
					msg1 += Messages.get(this, "intro_ninja");
					break;
				case DM400:
					msg1 += Messages.get(this, "intro_dm400");
					break;
                case PRINCESS:
                        msg1 += Messages.get(this, "intro_princess");
                    break;
                case FRIAR:
                    msg1 += Messages.get(this, "intro_friar");
                    break;
			}
