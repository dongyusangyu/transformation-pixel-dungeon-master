...
public class Hero extends Char {
	...
	public void updateHT( boolean boostHP ){
		...
		//史莱姆
		if (this.subClass == HeroSubClass.WATERSLIME){
		...
		//史莱姆
		if (this.subClass == HeroSubClass.DARKSLIME){
			HT *= 0.8f;
		}
		if(HT<1){
			HT=1;
	...
	public int talentPointsAvailable(int tier){
		...
		if (avalvl < (Talent.tierLevelThresholds[tier] - 1)
			|| (tier == 3 && subClass == HeroSubClass.NONE && Dungeon.hero.heroClass!= HeroClass.FREEMAN)
	...
	public int drRoll() {
		...
		if(subClass==HeroSubClass.AU400){
	...
	public int damageRoll() {
		...
		if(hasTalent(Talent.SHADOW_KILLER) && wep!=null){
			...
			if (enemy instanceof Mob && ((Mob) enemy).surprisedBy(hero)) {
				...
				dmg=damage+(int)(enemy.drRoll()*(0.5f+0.5f*pointsInTalent(Talent.SHADOW_KILLER)));
			}
		}
	...
	public void rest( boolean fullRest ) {
		...
		if(pointsNegative(Talent.LIFE_SPORT)>0){
			damage(pointsNegative(Talent.LIFE_SPORT),new MagicMissile());
		}
