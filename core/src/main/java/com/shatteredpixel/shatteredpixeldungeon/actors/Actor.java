...
public abstract class Actor implements Bundlable {
	...
	public static boolean isSpecialEnemyAlignment( Char.Alignment alignment ){
		return alignment == Char.Alignment.ENEMY1
				|| alignment == Char.Alignment.ENEMY2
				|| alignment == Char.Alignment.ENEMY3
				|| alignment == Char.Alignment.ENEMY4;
	}

	public static boolean isHostile( Char source, Char target ){
		if (source == null || target == null || source == target
				|| source.alignment == null || target.alignment == null
				|| source.alignment == Char.Alignment.NEUTRAL
				|| target.alignment == Char.Alignment.NEUTRAL) {
			return false;
		}

		boolean sourceIsSpecialEnemy = isSpecialEnemyAlignment(source.alignment);
		boolean targetIsSpecialEnemy = isSpecialEnemyAlignment(target.alignment);
