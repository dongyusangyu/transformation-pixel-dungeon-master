...
public class WaterOfHealth extends WellWater {
	...
	protected boolean affectHero( Hero hero ) {
		...
		if(Dungeon.isChallenged(Challenges.NO_HEALING) && Dungeon.isChallenged(Challenges.HARSH_ENVIRONMENT)){
	...
	protected Item affectItem( Item item, int pos ) {
		if(Dungeon.isChallenged(Challenges.NO_HEALING) && Dungeon.isChallenged(Challenges.HARSH_ENVIRONMENT) && !ScrollOfRemoveCurse.uncursable(item)){
