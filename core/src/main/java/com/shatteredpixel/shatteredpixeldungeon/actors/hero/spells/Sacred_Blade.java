                            ...
                            new Callback() {
                                ...
                                public void call() {
                                    ...
                                    if(hero.belongings.weapon!=null){
                                        max = hero.belongings.weapon.damageRoll(hero);
                                    }


                                    if(hero.pointsInTalent(Talent.SACRED_BLADE)>1){
                                        if ((Char.hasProp(enemy, Char.Property.UNDEAD) || Char.hasProp(enemy, Char.Property.DEMONIC)) && hero.belongings.weapon!=null){
