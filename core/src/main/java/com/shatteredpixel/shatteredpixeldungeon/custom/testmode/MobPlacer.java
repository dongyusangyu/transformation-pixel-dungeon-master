...
public class MobPlacer extends TestItem {
    ...
    protected int maxMobIndex(int tier){
        switch (tier){
            ...
            case 8: return DataPack.THYMOR.ordinal() - DataPack.GNOLL_SAPPER.ordinal() - 1;
            case 9: return DataPack.TEST_GREAT_SHOPER.ordinal() - DataPack.THYMOR.ordinal() - 1;
            default: return DataPack.GREAT_CRAB.ordinal();
        }
    }
    private int dataThreshold(int tier){
        switch (tier){
            ...
            case 9:
                return DataPack.THYMOR.ordinal() + 1;
        }
    }
...
//                btn.icon( DictSpriteSheet.miscImages(allData.get(dataThreshold(mobTier)+i).imageId) );
    ...
    private enum DataPack{
        ...
        TEST_GOO(TestGoo.class, DictSpriteSheet.SLIME),
