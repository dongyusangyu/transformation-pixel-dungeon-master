...
abstract public class Variable<T> {
    ...
    static void putFromInventory(String key) {
        GameScene.selectItem(new WndBag.ItemSelector() {
            @Override
            public String textPrompt() { return Messages.get(Variable.class, "select_item"); }
            @Override
        ...
        GameScene.selectCell(new CellSelector.Listener() {
            ...
            public void onSelect(Integer cell) {
                ...
                if (objects.isEmpty()) {
                    ...
                    objects.add(0, cell);
                    objectNames.add(0, Messages.get(Variable.class, "cell", cell)); // include the actual value of the cell
            ...
            @Override public String prompt() { return Messages.get(Variable.class, "select_cell"); }
        });
    }
