...
public enum DictionaryJournal {
    ...
    static {
        ...
        ARMORS.d.put("armor_glyph_5",       DictSpriteSheet.BUFF_GLYPH_5);
        ...
        ARTIFACTS.d.put("artifact_shuriken",        ItemSpriteSheet.ARTIFACT_SHURIKEN);
        ARTIFACTS.d.put("artifact_tool",        ItemSpriteSheet.ARTIFACT_TOOL);
        ...
        ALCHEMY.d.put("bomb_shocking",      ItemSpriteSheet.SMOKE_BOMB);
        ...
        MOBS.d.put("mob_gnollexile",             DictSpriteSheet.GNOLL_EXILE);
        ...
        MOBS.d.put("mob_hermitcrab",              DictSpriteSheet.HERMIT_CRAB);
        ...
        RINGS.d.put("ring_king",            ItemSpriteSheet.RING_KING);
        ...
        WEAPONS.d.put("melee_walkstick",    ItemSpriteSheet.WALK_STICK);
        ...
        WEAPONS.d.put("melee_blowpipe",     ItemSpriteSheet.BLOWPIPE);
        ...
        WEAPONS.d.put("weapon_ench5",       DictSpriteSheet.BUFF_ENCH_5);
        //missile
        ...
        WEAPONS.d.put("missile_throwingspike",      ItemSpriteSheet.THROWING_SPIKE);
        WEAPONS.d.put("missile_luckycoin",      ItemSpriteSheet.LUCKYCOIN);
        WEAPONS.d.put("missile_slimeball",      ItemSpriteSheet.SLIMEBALL);
        WEAPONS.d.put("missile_damagegear",      ItemSpriteSheet.GEAR);
        WEAPONS.d.put("missile_runestring",      ItemSpriteSheet.RUNESTRING);
        ...
        TRINKETS.d.put("trinket_goldingot",ItemSpriteSheet.GOLD_INGOT);
        TRINKETS.d.put("trinket_ferrettuft",ItemSpriteSheet.FERRET_TUFT);
        TRINKETS.d.put("trinket_bronzewatch",ItemSpriteSheet.BRONZE_WATCH);
